...
const title = "DBS Fixed Deposit Rates";
const description =
  "Analyse DBS fixed deposit rate trends in Singapore for the past 6 months, 1 year and 2 years.";
const url = Routes.FixedDepositRatesDbs;
...
export default function DbsFixedDepositRates() {
  return (
    <Container>
      ...
      <DepositRatesChart bank={DepositRateBank.DBS} />
      <Paragraph>
      ...
      <Paragraph>
        ...
        including DBS, and sends Telegram notifications when rates go up.
      </Paragraph>
      <Paragraph>
