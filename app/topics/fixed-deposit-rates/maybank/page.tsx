...
const title = "Maybank Fixed Deposit Rates";
const description =
  "Analyse Maybank fixed deposit rate trends in Singapore for the past 6 months, 1 year and 2 years.";
const url = Routes.FixedDepositRatesMaybank;
...
export default function MaybankFixedDepositRates() {
  return (
    <Container>
      ...
      <DepositRatesChart bank={DepositRateBank.MAYBANK} />
      <Paragraph>
      ...
      <Paragraph>
        ...
        including Maybank, and sends Telegram notifications when rates go up.
      </Paragraph>
      <Paragraph>
