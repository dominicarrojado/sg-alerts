...
const title = "Treasury Bills (T-Bills) Rates";
const description =
  "Track Singapore Treasury Bills (T-Bills) rate trends over the past 6 months, 1 year and 2 years.";
const url = Routes.FixedDepositRatesTBills;
...
export default function TreasuryBillsRates() {
  return (
    <Container>
      ...
      <DepositRatesChart
        ...
        title="Treasury Bills (T-Bills) Rate Trend"
      />
      <Paragraph>
        The chart above shows recent Singapore Treasury Bills (T-Bills) rate
      ...
      <Paragraph>
        ...
        alternatives in Singapore, including T-Bills, and sends Telegram
