...
const title = "CIMB Fixed Deposit Rates";
const description =
  "Analyse CIMB fixed deposit rate trends in Singapore for the past 6 months, 1 year and 2 years.";
const url = Routes.FixedDepositRatesCimb;
...
export default function CimbFixedDepositRates() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        including CIMB, and sends Telegram notifications when rates go up.
      </Paragraph>
      <Paragraph>
