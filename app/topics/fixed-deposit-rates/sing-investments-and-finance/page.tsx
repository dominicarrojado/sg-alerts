...
const title = "Sing Investments & Finance Fixed Deposit Rates";
const description =
  "Analyse Sing Investments & Finance fixed deposit rate trends in Singapore for the past 6 months, 1 year and 2 years.";
const url = Routes.FixedDepositRatesSif;
...
export default function SifFixedDepositRates() {
  return (
    <Container>
