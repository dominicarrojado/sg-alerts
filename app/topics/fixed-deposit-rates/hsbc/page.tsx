...
const title = "HSBC Fixed Deposit Rates";
const description =
  "Analyse HSBC fixed deposit rate trends in Singapore for the past 6 months, 1 year and 2 years.";
const url = Routes.FixedDepositRatesHsbc;
...
export default function HsbcFixedDepositRates() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        including HSBC, and sends Telegram notifications when rates go up.
      </Paragraph>
      <Paragraph>
