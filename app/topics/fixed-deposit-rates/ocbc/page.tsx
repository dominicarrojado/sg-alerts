...
const title = "OCBC Fixed Deposit Rates";
const description =
  "Analyse OCBC fixed deposit rate trends in Singapore for the past 6 months, 1 year and 2 years.";
const url = Routes.FixedDepositRatesOcbc;
...
export default function OcbcFixedDepositRates() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        including OCBC, and sends Telegram notifications when rates go up.
      </Paragraph>
      <Paragraph>
