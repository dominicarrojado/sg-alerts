...
const title = "UOB Fixed Deposit Rates";
const description =
  "Analyse UOB fixed deposit rate trends in Singapore for the past 6 months, 1 year and 2 years.";
const url = Routes.FixedDepositRatesUob;
...
export default function UobFixedDepositRates() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        including UOB, and sends Telegram notifications when rates go up.
      </Paragraph>
      <Paragraph>
