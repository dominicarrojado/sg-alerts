...
const title = "Hong Leong Finance Fixed Deposit Rates";
const description =
  "Analyse Hong Leong Finance fixed deposit rate trends in Singapore for the past 6 months, 1 year and 2 years.";
const url = Routes.FixedDepositRatesHongLeongFinance;
...
export default function HongLeongFinanceFixedDepositRates() {
  return (
    <Container>
