...
const title = "Bank of China Fixed Deposit Rates";
const description =
  "Analyse Bank of China fixed deposit rate trends in Singapore for the past 6 months, 1 year and 2 years.";
const url = Routes.FixedDepositRatesBankOfChina;
...
export default function BankOfChinaFixedDepositRates() {
  return (
    <Container>
