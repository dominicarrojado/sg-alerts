...
const title = "Standard Chartered Fixed Deposit Rates";
const description =
  "Analyse Standard Chartered fixed deposit rate trends in Singapore for the past 6 months, 1 year and 2 years.";
const url = Routes.FixedDepositRatesStandardChartered;
...
export default function StandardCharteredFixedDepositRates() {
  return (
    <Container>
