...
const title = "ICBC Fixed Deposit Rates";
const description =
  "Analyse ICBC fixed deposit rate trends in Singapore for the past 6 months, 1 year and 2 years.";
const url = Routes.FixedDepositRatesIcbc;
...
export default function IcbcFixedDepositRates() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        including ICBC, and sends Telegram notifications when rates go up.
      </Paragraph>
      <Paragraph>
