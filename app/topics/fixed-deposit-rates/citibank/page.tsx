...
const title = "Citibank Fixed Deposit Rates";
const description =
  "Analyse Citibank fixed deposit rate trends in Singapore for the past 6 months, 1 year and 2 years.";
const url = Routes.FixedDepositRatesCitibank;
...
export default function CitibankFixedDepositRates() {
  return (
    <Container>
      ...
      <DepositRatesChart bank={DepositRateBank.CITIBANK} />
      <Paragraph>
      ...
      <Paragraph>
        ...
        including Citibank, and sends Telegram notifications when rates go up.
      </Paragraph>
      <Paragraph>
