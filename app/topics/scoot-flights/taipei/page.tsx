...
const title = "Scoot Flights to Taipei";
const description =
  "Analyse Scoot fare trends from Singapore to Taipei for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsTaipei;
...
export default function ScootFlightsTaipei() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        to Taipei (TPE) for the past 6 months, 1 year and 2 years. You can use
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Taipei.
