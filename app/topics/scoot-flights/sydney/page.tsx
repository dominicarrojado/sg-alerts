...
const title = "Scoot Flights to Sydney";
const description =
  "Analyse Scoot fare trends from Singapore to Sydney for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsSydney;
...
export default function ScootFlightsSydney() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        to Sydney (SYD) for the past 6 months, 1 year and 2 years. You can use
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Sydney.
