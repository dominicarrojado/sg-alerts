...
const title = "Scoot Flights to Guangzhou";
const description =
  "Analyse Scoot fare trends from Singapore to Guangzhou for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsGuangzhou;
...
export default function ScootFlightsGuangzhou() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        to Guangzhou (CAN) for the past 6 months, 1 year and 2 years. You can
      ...
      <Paragraph>
        ...
        Guangzhou. It sends you a Telegram notification when the prices go down
