...
const title = "Scoot Flights to Ho Chi Minh City";
const description =
  "Analyse Scoot fare trends from Singapore to Ho Chi Minh City for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsHoChiMinhCity;
...
export default function ScootFlightsHoChiMinhCity() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        to Ho Chi Minh City (SGN) for the past 6 months, 1 year and 2 years. You
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Ho Chi
        Minh City. It sends you a Telegram notification when the prices go down
