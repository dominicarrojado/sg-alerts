...
const title = "Scoot Flights to Denpasar Bali";
const description =
  "Analyse Scoot fare trends from Singapore to Denpasar Bali for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsDenpasarBali;
...
export default function ScootFlightsDenpasarBali() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        to Denpasar Bali (DPS) for the past 6 months, 1 year and 2 years. You
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Denpasar
        Bali. It sends you a Telegram notification when the prices go down so
