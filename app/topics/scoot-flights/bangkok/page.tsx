...
const title = "Scoot Flights to Bangkok";
const description =
  "Analyse Scoot fare trends from Singapore to Bangkok for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsBangkok;
...
export default function ScootFlightsBangkok() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        to Bangkok (BKK) for the past 6 months, 1 year and 2 years. You can use
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Bangkok.
