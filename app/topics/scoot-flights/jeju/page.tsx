...
const title = "Scoot Flights to Jeju";
const description =
  "Analyse Scoot fare trends from Singapore to Jeju for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsJeju;
...
export default function ScootFlightsJeju() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Jeju Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Scoot flights from Singapore
        to Jeju (CJU) for the past 6 months, 1 year and 2 years. You can use
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Jeju. It
