...
const title = "Scoot Flights to Tokyo";
const description =
  "Analyse Scoot fare trends from Singapore to Tokyo for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsTokyo;
...
export default function ScootFlightsTokyo() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        to Tokyo (TYO) for the past 6 months, 1 year and 2 years. You can use
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Tokyo.
