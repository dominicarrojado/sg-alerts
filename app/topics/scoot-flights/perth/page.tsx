...
const title = "Scoot Flights to Perth";
const description =
  "Analyse Scoot fare trends from Singapore to Perth for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsPerth;
...
export default function ScootFlightsPerth() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        to Perth (PER) for the past 6 months, 1 year and 2 years. You can use
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Perth.
