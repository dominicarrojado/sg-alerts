...
const title = "Scoot Flights to Tiruchirappalli";
const description =
  "Analyse Scoot fare trends from Singapore to Tiruchirappalli for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsTiruchirappalli;
...
export default function ScootFlightsTiruchirappalli() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="TRZ"
        chartTitle="Tiruchirappalli Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Scoot flights from Singapore
        to Tiruchirappalli (TRZ) for the past 6 months, 1 year and 2 years. You
        can use this information to decide when to{" "}
      ...
      <Paragraph>
        ...
        Tiruchirappalli. It sends you a Telegram notification when the prices go
        down so that you can take advantage of the lower prices.
      </Paragraph>
      <Paragraph>
