...
const title = "Scoot Flights to Phuket";
const description =
  "Analyse Scoot fare trends from Singapore to Phuket for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsPhuket;
...
export default function ScootFlightsPhuket() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        to Phuket (HKT) for the past 6 months, 1 year and 2 years. You can use
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Phuket.
