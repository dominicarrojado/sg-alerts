...
const title = "Scoot Flights to Osaka";
const description =
  "Analyse Scoot fare trends from Singapore to Osaka for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsOsaka;
...
export default function ScootFlightsOsaka() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        to Osaka (KIX) for the past 6 months, 1 year and 2 years. You can use
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Osaka.
