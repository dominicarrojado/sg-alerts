...
const title = "Scoot Flights to Seoul";
const description =
  "Analyse Scoot fare trends from Singapore to Seoul for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsSeoul;
...
export default function ScootFlightsSeoul() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        to Seoul (ICN) for the past 6 months, 1 year and 2 years. You can use
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Seoul.
