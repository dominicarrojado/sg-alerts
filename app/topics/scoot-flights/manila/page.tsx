...
const title = "Scoot Flights to Manila";
const description =
  "Analyse Scoot fare trends from Singapore to Manila for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsManila;
...
export default function ScootFlightsManila() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        to Manila (MNL) for the past 6 months, 1 year and 2 years. You can use
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Manila.
