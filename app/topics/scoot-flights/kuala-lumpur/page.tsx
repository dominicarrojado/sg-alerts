...
const title = "Scoot Flights to Kuala Lumpur";
const description =
  "Analyse Scoot fare trends from Singapore to Kuala Lumpur for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsKualaLumpur;
...
export default function ScootFlightsKualaLumpur() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        to Kuala Lumpur (KUL) for the past 6 months, 1 year and 2 years. You can
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Kuala
        Lumpur. It sends you a Telegram notification when the prices go down so
