...
const title = "Scoot Flights to Hangzhou";
const description =
  "Analyse Scoot fare trends from Singapore to Hangzhou for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsHangzhou;
...
export default function ScootFlightsHangzhou() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        to Hangzhou (HGH) for the past 6 months, 1 year and 2 years. You can use
      ...
      <Paragraph>
        ...
        Hangzhou. It sends you a Telegram notification when the prices go down
