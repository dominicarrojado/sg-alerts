...
const title = "Scoot Flights to Macau";
const description =
  "Analyse Scoot fare trends from Singapore to Macau for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsMacau;
...
export default function ScootFlightsMacau() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="MFM"
        chartTitle="Macau Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Scoot flights from Singapore
        to Macau (MFM) for the past 6 months, 1 year and 2 years. You can use
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Macau.
