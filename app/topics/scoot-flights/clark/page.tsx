...
const title = "Scoot Flights to Clark";
const description =
  "Analyse Scoot fare trends from Singapore to Clark for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsClark;
...
export default function ScootFlightsClark() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="CRK"
        chartTitle="Clark Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Scoot flights from Singapore
        to Clark (CRK) for the past 6 months, 1 year and 2 years. You can use
