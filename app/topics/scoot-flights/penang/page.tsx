...
const title = "Scoot Flights to Penang";
const description =
  "Analyse Scoot fare trends from Singapore to Penang for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsPenang;
...
export default function ScootFlightsPenang() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        to Penang (PEN) for the past 6 months, 1 year and 2 years. You can use
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Penang.
