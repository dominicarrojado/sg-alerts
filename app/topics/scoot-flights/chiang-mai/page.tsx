...
const title = "Scoot Flights to Chiang Mai";
const description =
  "Analyse Scoot fare trends from Singapore to Chiang Mai for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsChiangMai;
...
export default function ScootFlightsChiangMai() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="CNX"
        chartTitle="Chiang Mai Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Scoot flights from Singapore
        to Chiang Mai (CNX) for the past 6 months, 1 year and 2 years. You can
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Chiang
        Mai. It sends you a Telegram notification when the prices go down so
