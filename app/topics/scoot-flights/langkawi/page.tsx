...
const title = "Scoot Flights to Langkawi";
const description =
  "Analyse Scoot fare trends from Singapore to Langkawi for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsLangkawi;
...
export default function ScootFlightsLangkawi() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="LGK"
        chartTitle="Langkawi Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Scoot flights from Singapore
        to Langkawi (LGK) for the past 6 months, 1 year and 2 years. You can use
      ...
      <Paragraph>
        ...
        Langkawi. It sends you a Telegram notification when the prices go down
