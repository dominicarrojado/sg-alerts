...
const title = "Scoot Flights to Hong Kong";
const description =
  "Analyse Scoot fare trends from Singapore to Hong Kong for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsHongKong;
...
export default function ScootFlightsHongKong() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Hong Kong Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Scoot flights from Singapore
        to Hong Kong (HKG) for the past 6 months, 1 year and 2 years. You can
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Hong
        Kong. It sends you a Telegram notification when the prices go down so
