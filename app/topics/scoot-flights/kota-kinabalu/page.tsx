...
const title = "Scoot Flights to Kota Kinabalu";
const description =
  "Analyse Scoot fare trends from Singapore to Kota Kinabalu for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsKotaKinabalu;
...
export default function ScootFlightsKotaKinabalu() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="BKI"
        chartTitle="Kota Kinabalu Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Scoot flights from Singapore
        to Kota Kinabalu (BKI) for the past 6 months, 1 year and 2 years. You
      ...
      <Paragraph>
        ...
        service that monitors Scoot flight fare deals from Singapore to Kota
        Kinabalu. It sends you a Telegram notification when the prices go down
