...
const title = "Scoot Flights to Surabaya";
const description =
  "Analyse Scoot fare trends from Singapore to Surabaya for the past 6 months, 1 year and 2 years.";
const url = Routes.ScootFlightsSurabaya;
...
export default function ScootFlightsSurabaya() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        to Surabaya (SUB) for the past 6 months, 1 year and 2 years. You can use
      ...
      <Paragraph>
        ...
        Surabaya. It sends you a Telegram notification when the prices go down
