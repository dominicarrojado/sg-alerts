...
const title = "Singapore Airlines Flights to Los Angeles";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Los Angeles for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsLosAngeles;
...
export default function SingaporeAirlinesFlightsLosAngeles() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Los Angeles Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Los Angeles (LAX) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Los Angeles. It sends you a Telegram notification when the
