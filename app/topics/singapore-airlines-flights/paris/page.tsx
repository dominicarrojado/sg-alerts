...
const title = "Singapore Airlines Flights to Paris";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Paris for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsParis;
...
export default function SingaporeAirlinesFlightsParis() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Paris Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Paris (CDG) for the past 6 months, 1 year and 2 years.
      ...
      <Paragraph>
        ...
        Singapore to Paris. It sends you a Telegram notification when the prices
