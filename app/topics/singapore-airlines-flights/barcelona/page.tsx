...
const title = "Singapore Airlines Flights to Barcelona";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Barcelona for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsBarcelona;
...
export default function SingaporeAirlinesFlightsBarcelona() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Barcelona Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Barcelona (BCN) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Barcelona. It sends you a Telegram notification when the
