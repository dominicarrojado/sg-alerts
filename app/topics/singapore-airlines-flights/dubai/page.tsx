...
const title = "Singapore Airlines Flights to Dubai";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Dubai for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsDubai;
...
export default function SingaporeAirlinesFlightsDubai() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Dubai Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Dubai (DXB) for the past 6 months, 1 year and 2 years.
      ...
      <Paragraph>
        ...
        Singapore to Dubai. It sends you a Telegram notification when the prices
