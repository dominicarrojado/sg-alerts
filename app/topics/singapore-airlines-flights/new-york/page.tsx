...
const title = "Singapore Airlines Flights to New York";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to New York for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsNewYork;
...
export default function SingaporeAirlinesFlightsNewYork() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="New York Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to New York (NYC) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to New York. It sends you a Telegram notification when the
