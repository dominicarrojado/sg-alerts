...
const title = "Singapore Airlines Flights to Delhi";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Delhi for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsDelhi;
...
export default function SingaporeAirlinesFlightsDelhi() {
  return (
    <Container>
