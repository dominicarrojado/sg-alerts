...
const title = "Singapore Airlines Flights to Penang";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Penang for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsPenang;
...
export default function SingaporeAirlinesFlightsPenang() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="PEN"
        chartTitle="Penang Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Penang (PEN) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Penang. It sends you a Telegram notification when the
