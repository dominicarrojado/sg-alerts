...
const title = "Singapore Airlines Flights to Brisbane";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Brisbane for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsBrisbane;
...
export default function SingaporeAirlinesFlightsBrisbane() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="BNE"
        chartTitle="Brisbane Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Brisbane (BNE) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Brisbane. It sends you a Telegram notification when the
