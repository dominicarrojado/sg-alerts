...
const title = "Singapore Airlines Flights to Christchurch";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Christchurch for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsChristchurch;
...
export default function SingaporeAirlinesFlightsChristchurch() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="CHC"
        chartTitle="Christchurch Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Christchurch (CHC) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Christchurch. It sends you a Telegram notification when the
