...
const title = "Singapore Airlines Flights to Zurich";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Zurich for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsZurich;
...
export default function SingaporeAirlinesFlightsZurich() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="ZRH"
        chartTitle="Zurich Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Zurich (ZRH) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Zurich. It sends you a Telegram notification when the
