...
const title = "Singapore Airlines Flights to Phnom Penh";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Phnom Penh for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsPhnom;
...
export default function SingaporeAirlinesFlightsPhnomPenh() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="KTI"
        chartTitle="Phnom Penh Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Phnom Penh (KTI) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Phnom Penh. It sends you a Telegram notification when the
