...
const title = "Singapore Airlines Flights to Seattle";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Seattle for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsSeattle;
...
export default function SingaporeAirlinesFlightsSeattle() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="SEA"
        chartTitle="Seattle Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Seattle (SEA) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Seattle. It sends you a Telegram notification when the
