...
const title = "Singapore Airlines Flights to Bengaluru";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Bengaluru for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsBengaluru;
...
export default function SingaporeAirlinesFlightsBengaluru() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Bengaluru Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Bengaluru (BLR) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Bengaluru. It sends you a Telegram notification when the
