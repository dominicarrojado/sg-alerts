...
const title = "Singapore Airlines Flights to Copenhagen";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Copenhagen for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsCopenhagen;
...
export default function SingaporeAirlinesFlightsCopenhagen() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="CPH"
        chartTitle="Copenhagen Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Copenhagen (CPH) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Copenhagen. It sends you a Telegram notification when the
