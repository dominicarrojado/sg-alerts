...
const title = "Singapore Airlines Flights to Jakarta";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Jakarta for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsJakarta;
...
export default function SingaporeAirlinesFlightsJakarta() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Jakarta Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Jakarta (CGK) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Jakarta. It sends you a Telegram notification when the
