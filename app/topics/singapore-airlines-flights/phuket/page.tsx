...
const title = "Singapore Airlines Flights to Phuket";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Phuket for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsPhuket;
...
export default function SingaporeAirlinesFlightsPhuket() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="HKT"
        chartTitle="Phuket Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Phuket (HKT) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Phuket. It sends you a Telegram notification when the
