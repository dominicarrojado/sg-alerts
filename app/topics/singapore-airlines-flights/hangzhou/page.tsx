...
const title = "Singapore Airlines Flights to Hangzhou";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Hangzhou for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsHangzhou;
...
export default function SingaporeAirlinesFlightsHangzhou() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Hangzhou Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Hangzhou (HGH) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Hangzhou. It sends you a Telegram notification when the
