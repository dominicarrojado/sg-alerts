...
const title = "Singapore Airlines Flights to Siem Reap";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Siem Reap for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsSiemReap;
...
export default function SingaporeAirlinesFlightsSiemReap() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="SAI"
        chartTitle="Siem Reap Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Siem Reap (SAI) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Siem Reap. It sends you a Telegram notification when the
