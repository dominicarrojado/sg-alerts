...
const title = "Singapore Airlines Flights to Chennai";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Chennai for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsChennai;
...
export default function SingaporeAirlinesFlightsChennai() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        from Singapore to Chennai (MAA) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Chennai. It sends you a Telegram notification when the
