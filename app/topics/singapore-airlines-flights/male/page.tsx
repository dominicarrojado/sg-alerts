...
const title = "Singapore Airlines Flights to Male";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Male for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsMale;
...
export default function SingaporeAirlinesFlightsMale() {
  return (
    <Container>
