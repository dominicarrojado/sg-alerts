...
const title = "Singapore Airlines Flights to Manila";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Manila for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsManila;
...
export default function SingaporeAirlinesFlightsManila() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="MNL"
        chartTitle="Manila Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Manila (MNL) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Manila. It sends you a Telegram notification when the
