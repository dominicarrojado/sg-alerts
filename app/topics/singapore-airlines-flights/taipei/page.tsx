...
const title = "Singapore Airlines Flights to Taipei";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Taipei for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsTaipei;
...
export default function SingaporeAirlinesFlightsTaipei() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Taipei Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Taipei (TPE) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Taipei. It sends you a Telegram notification when the
