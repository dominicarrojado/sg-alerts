...
const title = "Singapore Airlines Flights to Amsterdam";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Amsterdam for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsAmsterdam;
...
export default function SingaporeAirlinesFlightsAmsterdam() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Amsterdam Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Amsterdam (AMS) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Amsterdam. It sends you a Telegram notification when the
