...
const title = "Singapore Airlines Flights to Adelaide";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Adelaide for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsAdelaide;
...
export default function SingaporeAirlinesFlightsAdelaide() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="ADL"
        chartTitle="Adelaide Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Adelaide (ADL) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Adelaide. It sends you a Telegram notification when the
