...
const title = "Singapore Airlines Flights to Melbourne";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Melbourne for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsMelbourne;
...
export default function SingaporeAirlinesFlightsMelbourne() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="MEL"
        chartTitle="Melbourne Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Melbourne (MEL) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Melbourne. It sends you a Telegram notification when the
