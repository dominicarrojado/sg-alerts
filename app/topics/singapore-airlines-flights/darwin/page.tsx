...
const title = "Singapore Airlines Flights to Darwin";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Darwin for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsDarwin;
...
export default function SingaporeAirlinesFlightsDarwin() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="DRW"
        chartTitle="Darwin Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Darwin (DRW) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Darwin. It sends you a Telegram notification when the
