...
const title = "Singapore Airlines Flights to Auckland";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Auckland for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsAuckland;
...
export default function SingaporeAirlinesFlightsAuckland() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="AKL"
        chartTitle="Auckland Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Auckland (AKL) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Auckland. It sends you a Telegram notification when the
