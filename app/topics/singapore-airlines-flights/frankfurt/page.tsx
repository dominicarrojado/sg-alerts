...
const title = "Singapore Airlines Flights to Frankfurt";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Frankfurt for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsFrankfurt;
...
export default function SingaporeAirlinesFlightsFrankfurt() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Frankfurt Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Frankfurt (FRA) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Frankfurt. It sends you a Telegram notification when the
