...
const title = "Singapore Airlines Flights to Tokyo";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Tokyo for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsTokyo;
...
export default function SingaporeAirlinesFlightsTokyo() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Tokyo Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Tokyo (TYO) for the past 6 months, 1 year and 2 years.
      ...
      <Paragraph>
        ...
        Singapore to Tokyo. It sends you a Telegram notification when the prices
