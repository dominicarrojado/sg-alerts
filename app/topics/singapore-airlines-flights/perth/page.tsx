...
const title = "Singapore Airlines Flights to Perth";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Perth for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsPerth;
...
export default function SingaporeAirlinesFlightsPerth() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="PER"
        chartTitle="Perth Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Perth (PER) for the past 6 months, 1 year and 2 years.
      ...
      <Paragraph>
        ...
        Singapore to Perth. It sends you a Telegram notification when the prices
