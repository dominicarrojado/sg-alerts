...
const title = "Singapore Airlines Flights to Shenzhen";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Shenzhen for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsShenzhen;
...
export default function SingaporeAirlinesFlightsShenzhen() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="SZX"
        chartTitle="Shenzhen Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Shenzhen (SZX) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Shenzhen. It sends you a Telegram notification when the
