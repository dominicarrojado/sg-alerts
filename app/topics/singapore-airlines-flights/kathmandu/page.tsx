...
const title = "Singapore Airlines Flights to Kathmandu";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Kathmandu for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsKathmandu;
...
export default function SingaporeAirlinesFlightsKathmandu() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Kathmandu Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Kathmandu (KTM) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Kathmandu. It sends you a Telegram notification when the
