...
const title = "Singapore Airlines Flights to Ho Chi Minh City";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Ho Chi Minh City for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsHoChiMinhCity;
...
export default function SingaporeAirlinesFlightsHoChiMinhCity() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Ho Chi Minh City Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Ho Chi Minh City (SGN) for the past 6 months, 1 year
        and 2 years. You can use this information to decide when to{" "}
      ...
      <Paragraph>
        ...
        Singapore to Ho Chi Minh City. It sends you a Telegram notification when
        the prices go down so that you can take advantage of the lower prices.
      </Paragraph>
      <Paragraph>
