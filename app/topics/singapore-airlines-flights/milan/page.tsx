...
const title = "Singapore Airlines Flights to Milan";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Milan for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsMilan;
...
export default function SingaporeAirlinesFlightsMilan() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="MXP"
        chartTitle="Milan Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Milan (MXP) for the past 6 months, 1 year and 2 years.
      ...
      <Paragraph>
        ...
        Singapore to Milan. It sends you a Telegram notification when the prices
