...
const title = "Singapore Airlines Flights to Xiamen";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Xiamen for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsXiamen;
...
export default function SingaporeAirlinesFlightsXiamen() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="XMN"
        chartTitle="Xiamen Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Xiamen (XMN) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Xiamen. It sends you a Telegram notification when the
