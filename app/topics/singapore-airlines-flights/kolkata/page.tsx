...
const title = "Singapore Airlines Flights to Kolkata";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Kolkata for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsKolkata;
...
export default function SingaporeAirlinesFlightsKolkata() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="CCU"
        chartTitle="Kolkata Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Kolkata (CCU) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Kolkata. It sends you a Telegram notification when the
