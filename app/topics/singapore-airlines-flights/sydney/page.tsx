...
const title = "Singapore Airlines Flights to Sydney";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Sydney for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsSydney;
...
export default function SingaporeAirlinesFlightsSydney() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Sydney Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Sydney (SYD) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Sydney. It sends you a Telegram notification when the
