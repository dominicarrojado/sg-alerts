...
const title = "Singapore Airlines Flights to Yangon";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Yangon for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsYangon;
...
export default function SingaporeAirlinesFlightsYangon() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="RGN"
        chartTitle="Yangon Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Yangon (RGN) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Yangon. It sends you a Telegram notification when the
