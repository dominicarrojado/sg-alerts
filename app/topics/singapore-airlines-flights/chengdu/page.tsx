...
const title = "Singapore Airlines Flights to Chengdu";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Chengdu for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsChengdu;
...
export default function SingaporeAirlinesFlightsChengdu() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="TFU"
        chartTitle="Chengdu Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Chengdu (TFU) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Chengdu. It sends you a Telegram notification when the
