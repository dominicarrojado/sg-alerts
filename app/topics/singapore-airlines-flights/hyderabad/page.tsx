...
const title = "Singapore Airlines Flights to Hyderabad";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Hyderabad for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsHyderabad;
...
export default function SingaporeAirlinesFlightsHyderabad() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Hyderabad Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Hyderabad (HYD) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Hyderabad. It sends you a Telegram notification when the
