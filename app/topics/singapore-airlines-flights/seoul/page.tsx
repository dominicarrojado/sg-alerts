...
const title = "Singapore Airlines Flights to Seoul";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Seoul for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsSeoul;
...
export default function SingaporeAirlinesFlightsSeoul() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="ICN"
        chartTitle="Seoul Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Seoul (ICN) for the past 6 months, 1 year and 2 years.
      ...
      <Paragraph>
        ...
        Singapore to Seoul. It sends you a Telegram notification when the prices
