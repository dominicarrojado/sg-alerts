...
const title = "Singapore Airlines Flights to Cebu";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Cebu for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsCebu;
...
export default function SingaporeAirlinesFlightsCebu() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="CEB"
        chartTitle="Cebu Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Cebu (CEB) for the past 6 months, 1 year and 2 years.
      ...
      <Paragraph>
        ...
        Singapore to Cebu. It sends you a Telegram notification when the prices
