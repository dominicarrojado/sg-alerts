...
const title = "Singapore Airlines Flights to Ahmedabad";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Ahmedabad for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsAhmedabad;
...
export default function SingaporeAirlinesFlightsAhmedabad() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Ahmedabad Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Ahmedabad (AMD) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Ahmedabad. It sends you a Telegram notification when the
