...
const title = "Singapore Airlines Flights to Colombo";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Colombo for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsColombo;
...
export default function SingaporeAirlinesFlightsColombo() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="CMB"
        chartTitle="Colombo Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Colombo (CMB) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Colombo. It sends you a Telegram notification when the
