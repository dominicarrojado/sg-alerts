...
const title = "Singapore Airlines Flights to Kochi";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Kochi for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsKochi;
...
export default function SingaporeAirlinesFlightsKochi() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="COK"
        chartTitle="Kochi Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Kochi (COK) for the past 6 months, 1 year and 2 years.
      ...
      <Paragraph>
        ...
        Singapore to Kochi. It sends you a Telegram notification when the prices
