...
const title = "Singapore Airlines Flights to Houston";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Houston for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsHouston;
...
export default function SingaporeAirlinesFlightsHouston() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="IAH"
        chartTitle="Houston Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Houston (IAH) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Houston. It sends you a Telegram notification when the
