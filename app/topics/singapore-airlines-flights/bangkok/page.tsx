...
const title = "Singapore Airlines Flights to Bangkok";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Bangkok for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsBangkok;
...
export default function SingaporeAirlinesFlightsBangkok() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Bangkok Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Bangkok (BKK) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Bangkok. It sends you a Telegram notification when the
