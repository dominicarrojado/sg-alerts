...
const title = "Singapore Airlines Flights to London";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to London for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsLondon;
...
export default function SingaporeAirlinesFlightsLondon() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="London Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to London (LON) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to London. It sends you a Telegram notification when the
