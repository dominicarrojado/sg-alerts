...
const title = "Singapore Airlines Flights to Cairns";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Cairns for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsCairns;
...
export default function SingaporeAirlinesFlightsCairns() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="CNS"
        chartTitle="Cairns Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Cairns (CNS) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Cairns. It sends you a Telegram notification when the
