...
const title = "Singapore Airlines Flights to Hong Kong";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Hong Kong for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsHongKong;
...
export default function SingaporeAirlinesFlightsHongKong() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        from Singapore to Hong Kong (HKG) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Hong Kong. It sends you a Telegram notification when the
