...
const title = "Singapore Airlines Flights to Manchester";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Manchester for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsManchester;
...
export default function SingaporeAirlinesFlightsManchester() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="MAN"
        chartTitle="Manchester Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Manchester (MAN) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Manchester. It sends you a Telegram notification when the
