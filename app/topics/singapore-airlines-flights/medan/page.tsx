...
const title = "Singapore Airlines Flights to Medan";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Medan for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsMedan;
...
export default function SingaporeAirlinesFlightsMedan() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Medan Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Medan (KNO) for the past 6 months, 1 year and 2 years.
      ...
      <Paragraph>
        ...
        Singapore to Medan. It sends you a Telegram notification when the prices
