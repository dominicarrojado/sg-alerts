...
const title = "Singapore Airlines Flights to Brussels";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Brussels for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsBrussels;
...
export default function SingaporeAirlinesFlightsBrussels() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Brussels Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Brussels (BRU) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Brussels. It sends you a Telegram notification when the
