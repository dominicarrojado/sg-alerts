...
const title = "Singapore Airlines Flights to Rome";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Rome for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsRome;
...
export default function SingaporeAirlinesFlightsRome() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Rome Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Rome (FCO) for the past 6 months, 1 year and 2 years.
      ...
      <Paragraph>
        ...
        Singapore to Rome. It sends you a Telegram notification when the prices
