...
const title = "Singapore Airlines Flights to Dhaka";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Dhaka for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsDhaka;
...
export default function SingaporeAirlinesFlightsDhaka() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="DAC"
        chartTitle="Dhaka Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Dhaka (DAC) for the past 6 months, 1 year and 2 years.
      ...
      <Paragraph>
        ...
        Singapore to Dhaka. It sends you a Telegram notification when the prices
