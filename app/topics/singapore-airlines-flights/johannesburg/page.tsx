...
const title = "Singapore Airlines Flights to Johannesburg";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Johannesburg for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsJohannesburg;
...
export default function SingaporeAirlinesFlightsJohannesburg() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="JNB"
        chartTitle="Johannesburg Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Johannesburg (JNB) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Johannesburg. It sends you a Telegram notification when the
