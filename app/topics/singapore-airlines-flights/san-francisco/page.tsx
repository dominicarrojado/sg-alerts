...
const title = "Singapore Airlines Flights to San Francisco";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to San Francisco for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsSanFrancisco;
...
export default function SingaporeAirlinesFlightsSanFrancisco() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="San Francisco Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to San Francisco (SFO) for the past 6 months, 1 year and
      ...
      <Paragraph>
        ...
        Singapore to San Francisco. It sends you a Telegram notification when
