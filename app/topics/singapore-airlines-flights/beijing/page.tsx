...
const title = "Singapore Airlines Flights to Beijing";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Beijing for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsBeijing;
...
export default function SingaporeAirlinesFlightsBeijing() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Beijing Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Beijing (BJS) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Beijing. It sends you a Telegram notification when the
