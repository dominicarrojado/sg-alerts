...
const title = "Singapore Airlines Flights to Osaka";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Osaka for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsOsaka;
...
export default function SingaporeAirlinesFlightsOsaka() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="KIX"
        chartTitle="Osaka Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Osaka (KIX) for the past 6 months, 1 year and 2 years.
      ...
      <Paragraph>
        ...
        Singapore to Osaka. It sends you a Telegram notification when the prices
