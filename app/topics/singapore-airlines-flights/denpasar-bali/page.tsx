...
const title = "Singapore Airlines Flights to Denpasar Bali";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Denpasar Bali for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsDenpasarBali;
...
export default function SingaporeAirlinesFlightsDenpasarBali() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Denpasar Bali Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Denpasar Bali (DPS) for the past 6 months, 1 year and
        2 years. You can use this information to decide when to{" "}
      ...
      <Paragraph>
        ...
        Singapore to Denpasar Bali. It sends you a Telegram notification when
