...
const title = "Singapore Airlines Flights to Mumbai";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Mumbai for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsMumbai;
...
export default function SingaporeAirlinesFlightsMumbai() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Mumbai Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Mumbai (BOM) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Mumbai. It sends you a Telegram notification when the
