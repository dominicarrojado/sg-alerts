...
const title = "Singapore Airlines Flights to Bandar Seri Begawan";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Bandar Seri Begawan for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsBandarSeriB;
...
export default function SingaporeAirlinesFlightsBandarSeriBegawan() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Bandar Seri Begawan Price Trend"
      />
      <Paragraph>
