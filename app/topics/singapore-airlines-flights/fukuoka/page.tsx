...
const title = "Singapore Airlines Flights to Fukuoka";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Fukuoka for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsFukuoka;
...
export default function SingaporeAirlinesFlightsFukuoka() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="FUK"
        chartTitle="Fukuoka Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Fukuoka (FUK) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Fukuoka. It sends you a Telegram notification when the
