...
const title = "Singapore Airlines Flights to Surabaya";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Surabaya for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsSurabaya;
...
export default function SingaporeAirlinesFlightsSurabaya() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Surabaya Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Surabaya (SUB) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Surabaya. It sends you a Telegram notification when the
