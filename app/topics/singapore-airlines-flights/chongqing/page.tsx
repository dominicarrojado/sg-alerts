...
const title = "Singapore Airlines Flights to Chongqing";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Chongqing for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsChongqing;
...
export default function SingaporeAirlinesFlightsChongqing() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="CKG"
        chartTitle="Chongqing Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Chongqing (CKG) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Chongqing. It sends you a Telegram notification when the
