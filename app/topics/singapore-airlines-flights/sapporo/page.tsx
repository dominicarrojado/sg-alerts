...
const title = "Singapore Airlines Flights to Sapporo";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Sapporo for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsSapporo;
...
export default function SingaporeAirlinesFlightsSapporo() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="CTS"
        chartTitle="Sapporo Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Sapporo (CTS) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Sapporo. It sends you a Telegram notification when the
