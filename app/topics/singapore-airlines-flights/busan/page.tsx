...
const title = "Singapore Airlines Flights to Busan";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Busan for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsBusan;
...
export default function SingaporeAirlinesFlightsBusan() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="PUS"
        chartTitle="Busan Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Busan (PUS) for the past 6 months, 1 year and 2 years.
      ...
      <Paragraph>
        ...
        Singapore to Busan. It sends you a Telegram notification when the prices
