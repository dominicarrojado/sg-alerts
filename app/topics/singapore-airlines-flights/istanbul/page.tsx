...
const title = "Singapore Airlines Flights to Istanbul";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Istanbul for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsIstanbul;
...
export default function SingaporeAirlinesFlightsIstanbul() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Istanbul Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Istanbul (IST) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Istanbul. It sends you a Telegram notification when the
