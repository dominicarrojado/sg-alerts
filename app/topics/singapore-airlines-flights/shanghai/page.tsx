...
const title = "Singapore Airlines Flights to Shanghai";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Shanghai for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsShanghai;
...
export default function SingaporeAirlinesFlightsShanghai() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="PVG"
        chartTitle="Shanghai Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Shanghai (PVG) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Shanghai. It sends you a Telegram notification when the
