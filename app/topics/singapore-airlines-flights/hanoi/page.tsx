...
const title = "Singapore Airlines Flights to Hanoi";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Hanoi for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsHanoi;
...
export default function SingaporeAirlinesFlightsHanoi() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="HAN"
        chartTitle="Hanoi Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Hanoi (HAN) for the past 6 months, 1 year and 2 years.
      ...
      <Paragraph>
        ...
        Singapore to Hanoi. It sends you a Telegram notification when the prices
