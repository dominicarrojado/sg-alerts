...
const title = "Singapore Airlines Flights to Guangzhou";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Guangzhou for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsGuangzhou;
...
export default function SingaporeAirlinesFlightsGuangzhou() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        chartTitle="Guangzhou Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Guangzhou (CAN) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Guangzhou. It sends you a Telegram notification when the
