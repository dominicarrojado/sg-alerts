...
const title = "Singapore Airlines Flights to Cape Town";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Cape Town for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsCapeTown;
...
export default function SingaporeAirlinesFlightsCapeTown() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="CPT"
        chartTitle="Cape Town Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Cape Town (CPT) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Cape Town. It sends you a Telegram notification when the
