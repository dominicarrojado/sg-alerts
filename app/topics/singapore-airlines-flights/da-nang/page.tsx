...
const title = "Singapore Airlines Flights to Da Nang";
const description =
  "Analyse Singapore Airlines fare trends from Singapore to Da Nang for the past 6 months, 1 year and 2 years.";
const url = Routes.SingaporeAirlinesFlightsDaNang;
...
export default function SingaporeAirlinesFlightsDaNang() {
  return (
    <Container>
      ...
      <FlightPriceChart
        ...
        destinationCityCode="DAD"
        chartTitle="Da Nang Price Trend"
      />
      <Paragraph>
        The above chart shows the fare trends for Singapore Airlines flights
        from Singapore to Da Nang (DAD) for the past 6 months, 1 year and 2
      ...
      <Paragraph>
        ...
        Singapore to Da Nang. It sends you a Telegram notification when the
