...
const title = "Badminton Court Slots (Heartbeat @ Bedok)";
const description =
  "Get notified when peak hour badminton court slots at Heartbeat @ Bedok ActiveSG Sport Hall become available for instant booking.";
const url = Routes.BadmintonCourtSlotsHeartbeatBedok;
...
export default function BadmintonCourtSlotsHeartbeatBedok() {
  return (
    <Container>
      ...
      <FacilitySlotsTable
        service={FacilityService.ACTIVE_SG_BADMINTON_COURT_HEARTBEAT}
      />
      <Paragraph>
      ...
      <Paragraph>
        ...
        via the{" "}
        <Anchor
          href="https://activesg.gov.sg/facility-bookings/activities/YLONatwvqJfikKOmB5N9U/venues/2vQVXKogKPojlagjzNxeX/timeslots?activityId=YLONatwvqJfikKOmB5N9U&venueId=2vQVXKogKPojlagjzNxeX"
          isExternal
        >
          ActiveSG website
        </Anchor>
      ...
      <Paragraph>
        ...
        unassigned peak hour slot at Heartbeat @ Bedok ActiveSG Sport Hall
      ...
      <div className="sticky bottom-6 z-50 mt-8 text-center">
        <TelegramLinkButton
          topicTitle={TopicTitle.BadmintonCourtSlotsHeartbeatBedok}
          channel={TelegramChannel.BadmintonCourtSlotsHeartbeatBedok}
