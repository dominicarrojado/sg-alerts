...
const title =
  "ComfortDelGro Driving Centre Class 2B Motorcycle Practical Lesson Slots";
const description =
  "Subscribe to SG Alerts to get notified when there are new practical lesson slot(s) for Class 2B Motorcycle at the ComfortDelGro Driving Centre (CDC) website.";
const url = Routes.CdcClass2BPracticalLessonSlots;
...
export default function CdcClass2BPracticalLessonSlots() {
  return (
    <Container>
      ...
      <Paragraph>
        ...
        website for available practical lesson slots for Class 2B Motorcycle. It
      ...
      <div className="sticky bottom-6 z-50 mt-8 text-center">
        <TelegramLinkButton
          channel={TelegramChannel.CdcLessonsClass2B}
          linkText="Subscribe Now"
          topicTitle={TopicTitle.CdcPracticalLessonSlotsClass2B}
        />
      </div>
    </Container>
  );
