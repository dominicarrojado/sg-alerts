...
export function JapanVisaSlotsTable() {
  ...
  const japanVisaSlotsInfoItems: JapanVisaSlotsInfoItems = [
    ...
    },
    {
      ...
      lastAvailableDate: japanVisaSlotsInfo[JapanVisaType.BUSINESS],
    },
  ];

  useEffect(() => {
    getJapanVisaSlotsInfo();
