...
export function CdcLessonSlotsTable() {
  ...
  const cdcLessonSlotsInfoItems: CdcClass2SlotsInfoItems = [
    {
      service: CdcLessonsService.CLASS_2A_L1,
      title: "Class 2A Motorcycle (Lesson 1)",
      lastAvailableDate: cdcSlotsDatesMap[CdcLessonsService.CLASS_2A_L1],
    },
    {
      service: CdcLessonsService.CLASS_2A_L2,
      title: "Class 2A Motorcycle (Lesson 2)",
      lastAvailableDate: cdcSlotsDatesMap[CdcLessonsService.CLASS_2A_L2],
    },
    {
      service: CdcLessonsService.CLASS_2A_L3,
      title: "Class 2A Motorcycle (Lesson 3)",
      lastAvailableDate: cdcSlotsDatesMap[CdcLessonsService.CLASS_2A_L3],
    },
  ];
