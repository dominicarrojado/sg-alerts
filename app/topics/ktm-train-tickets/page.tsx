  ...
  return (
    <Container>
      <div className="space-y-2">
        ...
        <Subheading>
          Receive email notifications when there are KTM train tickets available
      ...
      <TrainTicketsTable />
      <Paragraph>
        <span className="font-medium">KTM Train</span> is a popular mode of
        transport for people travelling between Singapore and Johor Bahru (
        <abbr title="Johor Bahru" className="no-underline">
          JB
        </abbr>
      ...
      <Paragraph>
        Due to the high demand for KTM train tickets, peak days and time slots
        are often sold out quickly. You will have to keep checking the booking
        websites to see if there are new tickets available or if someone has
        cancelled their tickets. This can be time-consuming and frustrating.
      </Paragraph>
      <Paragraph>
        <span className="font-medium">SG Alerts</span> can help you to stay
        updated with the latest KTM train tickets availability up to 3 months in
        advance. We will send you an email notification when there are new
        tickets available. This will save you time and effort from having to
        check the booking websites frequently.
      </Paragraph>
      <Paragraph>
      ...
      <Paragraph>
        ...
        <span className="font-medium">Train Tickets (KTM)</span> as one of the
